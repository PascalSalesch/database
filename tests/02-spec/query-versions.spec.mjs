 ...
 */
describe('Versioning queries', async () => {
  it('should include all versions if no options are provided', async () => {
  ...
  it('should exclude versions before the "from" version', async () => {
    const from = '2.0.0'
    const to = undefined
  ...
  it('should exclude versions after the "to" version', async () => {
    const from = undefined
    const to = '1.0.0'
    const versions = ['2.0.0', '1.0.0']
    const filtered = getVersions(versions, { from, to })
  ...
  it('should include equal versions only if it is labeled', async () => {
    const from = '2.0.0'
  ...
  it('should not include "from" versions even if they are labeled ', async () => {
  ...
  it('should treat labeled versions as more recent than unlabeled versions ', async () => {
    const from = '2.0.0-beta.1'
    const to = undefined
  ...
  it('should do "0.0.0" first', async () => {
    const from = undefined
    const to = undefined
